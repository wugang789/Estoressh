...
if(kfguin)
{
  ...
  if(type==1 && kf_getCookie('hasshown')==0)
  {
      ...
      window.setTimeout("kf_sleepShow()",1000);
      //kf_sleepShow();
  }
...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword)
{
    ...
    temp += '<div><h1 style="	float:left;font-size: 14px;color: #FFFFFF;margin: 0px;padding: 10px 0 13px 2px;line-height:7px;">'+companyname+'</h1><a href="#" onclick="kf_hidekfpopup();return false;" style="background-image: url('+urlroot+'close.gif);margin-right: -26px;margin-top: 6px;float: right;height: 26px;width: 18px;" onmouseover="javascript:this.style.backgroundPosition=\'bottom\'" onmouseleave="javascript:this.style.backgroundPosition=\'top\'"></a></div>';
    temp += '<div style="height:83px;padding: 0 0 0 2px;clear:both;">';
    temp += '<div style="background-image: url('+urlroot+'face.jpg);height: 70px;width: 70px;float:left;padding: 8px 0 0 0;background-position: left bottom;background-repeat: no-repeat;"></div>';
...
{
	window.open('http://wpa.qq.com/msgrd?v=3&uin=634143248&site=qq&menu=yes', '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
